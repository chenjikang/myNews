...
- (void)setup {
    // 创建UICollectionView
    UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:self.bounds collectionViewLayout:[[HMLoopViewLayout alloc] init]];
    // 注册cell
    [collectionView registerClass:[HMLoopViewCell class] forCellWithReuseIdentifier:@"loopView"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    // 从缓存池获得cell
    HMLoopViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"loopView" forIndexPath:indexPath];
